...
namespace NtcStudyBuddy.DataAccess.Migrations
{
    ...
    [Migration("20230914184903_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.Deck", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.DeckFlashCard", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.DeckGroup", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.DeckGroupDeck", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.FlashCard", b =>
                {
                    b.Property<int>("FlashCardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.StudySession", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.StudySessionFlashCard", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.UserDeck", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.UserDeckGroup", b =>
                {
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.DeckFlashCard", b =>
                {
                    b.HasOne("NtcStudyBuddy.DataAccess.Models.Deck", "Deck")
                        .WithMany("DeckFlashCards")
                        .HasForeignKey("DeckFlashCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NtcStudyBuddy.DataAccess.Models.FlashCard", "FlashCard")
                        .WithOne("DeckFlashCard")
                        .HasForeignKey("NtcStudyBuddy.DataAccess.Models.DeckFlashCard", "DeckFlashCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.DeckGroupDeck", b =>
                {
                    b.HasOne("NtcStudyBuddy.DataAccess.Models.DeckGroup", "DeckGroup")
                        .WithOne("DeckGroupDeck")
                        .HasForeignKey("NtcStudyBuddy.DataAccess.Models.DeckGroupDeck", "DeckGroupDeckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.StudySession", b =>
                {
                    ...
                    b.HasOne("NtcStudyBuddy.DataAccess.Models.User", "User")
                        .WithMany("StudySessions")
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.StudySessionFlashCard", b =>
                {
                    b.HasOne("NtcStudyBuddy.DataAccess.Models.FlashCard", "FlashCard")
                        ...
                        .HasForeignKey("NtcStudyBuddy.DataAccess.Models.StudySessionFlashCard", "StudySessionFlashCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NtcStudyBuddy.DataAccess.Models.StudySession", "StudySession")
                        .WithOne("StudySessionFlashCard")
                        .HasForeignKey("NtcStudyBuddy.DataAccess.Models.StudySessionFlashCard", "StudySessionFlashCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.UserDeck", b =>
                {
                    b.HasOne("NtcStudyBuddy.DataAccess.Models.Deck", "Deck")
                        .WithOne("UserDeck")
                        .HasForeignKey("NtcStudyBuddy.DataAccess.Models.UserDeck", "DeckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NtcStudyBuddy.DataAccess.Models.UserDeckGroup", b =>
                {
                    b.HasOne("NtcStudyBuddy.DataAccess.Models.DeckGroup", "DeckGroup")
                        ...
                        .HasForeignKey("NtcStudyBuddy.DataAccess.Models.UserDeckGroup", "UserDeckGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
